...
public class AdapterCreatePostPhotos extends RecyclerView.Adapter<AdapterCreatePostPhotos.ViewHolder> {
    ...
    public AdapterCreatePostPhotos(ArrayList<Uri> uriArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.item_photo_create_post, parent, false);
